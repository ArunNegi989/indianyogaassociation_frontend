        ...
        <div className={styles.rightPanel}>
          ...
          <div className={styles.formHeader}>
            ...
            <p className={styles.formSubtitle}>
              Secure your spot in our invigorating yoga classes today! Join our vibrant community of
              wellness enthusiasts and unlock the countless physical and mental benefits of yoga. Don't
              miss out – register now and embark on your journey to a healthier, more balanced life.
              "Join our yoga classes for a healthier, balanced life. Register now!"
            </p>
          </div>
