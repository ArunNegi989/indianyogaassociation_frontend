...
/* ════════════════════════════════════════
   CURRICULUM ITEMS (What You'll Study)
════════════════════════════════════════ */
const INIT_CURRICULUM: string[] = [
...
interface FormData {
  ...
  // Curriculum Section (What You'll Study)
...
export default function AddWorldwidePage() {
  ...
  const benefitsSubtextRef = useRef(""); // Benefits subtext as rich text
  ...
  /* Dynamic lists */
  const [curriculumItems, setCurriculumItems] = useState<string[]>(INIT_CURRICULUM);
        ...
        <Sec title="Curriculum Section - What You'll Study" badge="Course Content">
          ...
          <F label="Curriculum Introduction Paragraph" req>
            <StableJodit
              ...
              ph="Being one of the best yoga teacher training course providers in Rishikesh, we at AYM offer a comprehensive yoga curriculum. Our courses are designed to provide in-depth knowledge and skills in theory and practical form..."
              h={180}
          ...
          <F label="Additional Curriculum Paragraphs">
            {curriculumParaIds.map((id, i) => (
              <RichListItem
                ...
                ph="You'll learn about different topics and techniques of all levels — beginners, intermediate and advanced..."
              />
            ))}
        ...
        <Sec title="Teacher Team Section - Our Faculty" badge="Instructors">
          ...
          <F label="Teacher Team Description">
            <StableJodit
              ...
              ph="At AYM, our yoga teacher training course is conducted by reputed teachers with years of experience. Our teachers and staff offer a safe space for you to explore and grow..."
              h={200}
            />
          </F>
        ...
        <Sec title="Wellness / Commitment Box">
          ...
          <F label="Wellness Description">
            <StableJodit
              ...
              ph="Want to live a peaceful and healthy life? At AYM, we welcome you as a part of our family and allow you to commit to mental and physical wellness..."
              h={180}
            />
          </F>
        </Sec>
        ...
        <Sec title="Community Section - Worldwide Network" badge="Global Reach">
          ...
          <F label="Community Description">
            <StableJodit
              ...
              ph="Whether you want to deepen your knowledge of yoga or take a step towards a new career, our yoga teacher training course has got you covered..."
              h={200}
            />
          </F>
        </Sec>
