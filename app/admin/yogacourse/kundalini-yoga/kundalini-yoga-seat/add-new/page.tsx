...
export default function KundaliniSeatsAddPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/kundalini-seats/createBatch", {
      ...
      setSubmitted(true);
      setTimeout(() => {
        router.push("/admin/yogacourse/kundalini-yoga/kundalini-yoga-seat");
      }, 1500);
    } catch (err: any) {
    ...
    <div className={styles.formPage}>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.formActions}>
          <Link href="/admin/yogacourse/kundaliniyoga/kundalini-seats" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
