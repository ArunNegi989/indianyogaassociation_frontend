...
export default function KundaliniSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/kundalini-seats/${id}`);
        ...
        router.replace("/admin/yogacourse/kundalini-yoga/kundalini-yoga-seat");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/kundalini-seats/${id}`, {
      ...
      setSubmitted(true);
      setTimeout(() => router.push("/admin/yogacourse/kundalini-yoga/kundalini-yoga-seat"), 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link href="/admin/yogacourse/kundalini-yoga/kundalini-yoga-seat" className={styles.breadcrumbLink}>
          Seats & Dates
        </Link>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.formActions}>
          <Link href="/admin/yogacourse/kundalini-yoga/kundalini-yoga-seat" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
