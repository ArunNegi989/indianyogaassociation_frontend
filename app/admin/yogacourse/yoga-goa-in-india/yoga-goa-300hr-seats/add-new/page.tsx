...
export default function Goa300hrSeatsAddPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/goa-300hr-seats/createBatch", {
      ...
      setSubmitted(true);
      setTimeout(() => {
        router.push("/admin/yogacourse/yoga-goa-in-india/yoga-goa-300hr-seats");
      }, 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Add New Batch — 300 Hour GOA</h1>
        <p className={styles.pageSubtitle}>Fill in all batch details including dates, fees and seat count</p>
      </div>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.sectionBlock}>
          ...
          {form.totalSeats && !isNaN(Number(form.totalSeats)) && Number(form.totalSeats) > 0 && (
            <div className={styles.seatsPreview}>
              ...
              <span className={styles.seatsPreviewNote}>(registrations aane par automatically kam hoga)</span>
            </div>
          )}
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.fieldGroup}>
            ...
            <p className={styles.fieldHint}>Shown below the dates table on the frontend (e.g. early bird discount info)</p>
