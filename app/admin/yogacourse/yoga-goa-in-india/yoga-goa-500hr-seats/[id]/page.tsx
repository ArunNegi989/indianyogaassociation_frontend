...
export default function Goa500hrSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/goa-500hr-seats/getBatch/${id}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/goa-500hr-seats/updateBatch/${id}`, {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Edit Batch — 500 Hour GOA</h1>
