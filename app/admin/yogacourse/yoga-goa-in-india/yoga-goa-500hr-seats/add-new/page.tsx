...
export default function Goa500hrSeatsAddPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/goa-500hr-seats/createBatch", {
      ...
      setSubmitted(true);
      setTimeout(() => {
        router.push("/admin/yogacourse/yoga-goa-in-india/yoga-goa-500hr-seats");
      }, 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Add New Batch — 500 Hour GOA</h1>
