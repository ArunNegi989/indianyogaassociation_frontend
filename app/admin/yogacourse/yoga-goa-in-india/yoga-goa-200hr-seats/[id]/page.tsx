...
export default function Goa200hrSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/goa-200hr-seats/getBatch/${id}`);
        ...
        router.replace("/admin/yogacourse/yoga-goa-in-india/yoga-goa-200hr-seats");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/goa-200hr-seats/updateBatch/${id}`, {
      ...
      setSubmitted(true);
      setTimeout(() => router.push("/admin/yogacourse/yoga-goa-in-india/yoga-goa-200hr-seats"), 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Edit Batch — 200 Hour GOA</h1>
