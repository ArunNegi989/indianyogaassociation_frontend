// FILE: src/app/admin/yogacourse/vinyasa-yoga-course/vinyasa-seats/[id]/page.tsx
"use client";
...
export default function VinyasaSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/vinyasa-seats/${id}`);
        ...
        router.replace("/admin/yogacourse/vinyasa-yoga-course/vinyasa-seats");
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        ...
        <p className={styles.pageSubtitle}>
          Update date, fees, seat availability and note for this vinyasa batch
        </p>
      </div>
