// FILE: src/app/admin/dashboard/200hr-seats/page.tsx
"use client";
...
export default function SeatsListPage() {
  ...
  try {
    const res = await api.get("/200hr-seats/getAllBatches");
  ...
  try {
    await api.delete(`/200hr-seats/deleteBatch/${deleteId}`);
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>200 Hour — Seats & Dates</h1>
          <p className={styles.pageSubtitle}>Manage upcoming batch dates, fees and seat availability</p>
        </div>
        <Link href="/admin/yogacourse/200hourscourse/200hr-seats/add-new" className={styles.addBtn}>
                ...
                <tr key={row._id} className={styles.row}>
                  ...
                  <td>
                    <div className={styles.actionBtns}>
                      <Link href={`/admin/yogacourse/200hourscourse/200hr-seats/${row._id}`} className={styles.editBtn}>
                        ✎ Edit
                      </Link>
