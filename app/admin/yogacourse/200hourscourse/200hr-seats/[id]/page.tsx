// FILE: src/app/admin/dashboard/200hr-seats/edit/[id]/page.tsx
"use client";
...
export default function SeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/200hr-seats/getBatch/${id}`);
        ...
        router.replace("/admin/yogacourse/200hourscourse/200hr-seats");
      } finally {
        setLoading(false);
      }
    };
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.twoCol}>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 75,000</p>
              <div className={`${styles.inputWrapPrefix} ${errors.inrDormPrice ? styles.inputError : ""} ${form.inrDormPrice && !errors.inrDormPrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>₹</span>
                <input type="number" className={styles.inputPrefixed} placeholder="75,000"
          ...
          <div className={styles.twoCol}>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 95,000</p>
              <div className={`${styles.inputWrapPrefix} ${errors.inrPrivatePrice ? styles.inputError : ""} ${form.inrPrivatePrice && !errors.inrPrivatePrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>₹</span>
                <input type="number" className={styles.inputPrefixed} placeholder="95,000"
