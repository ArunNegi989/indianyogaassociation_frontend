// FILE: src/app/admin/prenatal-seats/add-new/page.tsx
"use client";
...
export default function PrenatalSeatsAddPage() {
 ...
 const handleSubmit = async () => {
  ...
  try {
    ...
    await api.post("/prenatal-seats/createBatch", {
    ...
    /* ✅ RESET FORM (UX improvement) */
    setForm(EMPTY);

    setTimeout(() => {
      router.push("/admin/yogacourse/prenatal-yoga-course/prenatal-seats");
    }, 1500);
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link href="/admin/yogacourse/prenatal-yoga-course/prenatal-seats" className={styles.breadcrumbLink}>
          Prenatal Seats & Dates
        </Link>
      ...
      <div className={styles.pageHeader}>
        ...
        <p className={styles.pageSubtitle}>
          Fill in all prenatal batch details including dates, fees and seat count
        </p>
      </div>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.formActions}>
          <Link href="/admin/yogacourse/prenatal-yoga-course/prenatal-seats" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
