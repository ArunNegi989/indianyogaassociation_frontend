// FILE: src/app/admin/prenatal-seats/[id]/page.tsx
"use client";
...
export default function PrenatalSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/prenatal-seats/${id}`);
        ...
        router.replace("/admin/yogacourse/prenatal-yoga-course/prenatal-seats");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/prenatal-seats/${id}`, {
      ...
      setSubmitted(true);
      setTimeout(() => router.push("/admin/yogacourse/prenatal-yoga-course/prenatal-seats"), 1500);
    } catch (err: any) {
    ...
    <div className={styles.formPage}>
      ...
      <div className={styles.pageHeader}>
        ...
        <p className={styles.pageSubtitle}>
          Update date, fees, seat availability and note for this prenatal batch
        </p>
      </div>
