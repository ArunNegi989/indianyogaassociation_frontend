// FILE: src/app/admin/dashboard/300hr-seats/edit/[id]/page.tsx
"use client";
...
export default function Seats300EditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/300hr-seats/single/${id}`);
        ...
        router.replace("/admin/yogacourse/300hourscourse/300hr-seats");
      } finally {
        setLoading(false);
      }
    };
  ...
  const validate = (): boolean => {
    ...
    if (!form.privatePrice.trim())
      e.privatePrice = "USD Private price is required";
    ...
    if (
      form.bookedSeats.trim() &&
      isNaN(Number(form.bookedSeats))
    )
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/300hr-seats/update/${id}`, {
      ...
      setTimeout(
        () =>
          router.push("/admin/yogacourse/300hourscourse/300hr-seats"),
        1500
      );
    } catch (err: any) {
  ...
  const remaining =
    Number(form.totalSeats) - Number(form.bookedSeats);
  const isFull =
    Number(form.bookedSeats) >= Number(form.totalSeats);
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link
          href="/admin/yogacourse/300hourscourse/300hr-seats"
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.twoCol}>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 89,999 INR</p>
              <div
                className={`${styles.inputWrap} ${
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.dormPrice ? styles.inputError : ""
                } ${
                  form.dormPrice && !errors.dormPrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
                ...
                <input
                  ...
                  placeholder="849"
                  value={form.dormPrice}
                  onChange={(e) => set("dormPrice", e.target.value)}
                />
              </div>
              {errors.dormPrice && (
                <p className={styles.errorMsg}>⚠ {errors.dormPrice}</p>
              )}
            </div>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 69,999</p>
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.inrDormPrice ? styles.inputError : ""
                } ${
                  form.inrDormPrice && !errors.inrDormPrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
              ...
              {errors.inrDormPrice && (
                <p className={styles.errorMsg}>⚠ {errors.inrDormPrice}</p>
              )}
            </div>
          </div>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 999</p>
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.twinPrice ? styles.inputError : ""
                } ${
                  form.twinPrice && !errors.twinPrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
                ...
                <input
                  ...
                  className={styles.inputPrefixed}
                  placeholder="999"
                  value={form.twinPrice}
                  onChange={(e) => set("twinPrice", e.target.value)}
                />
              </div>
              {errors.twinPrice && (
                <p className={styles.errorMsg}>⚠ {errors.twinPrice}</p>
              )}
            </div>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 79,999</p>
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.inrTwinPrice ? styles.inputError : ""
                } ${
                  form.inrTwinPrice && !errors.inrTwinPrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
              ...
              {errors.inrTwinPrice && (
                <p className={styles.errorMsg}>⚠ {errors.inrTwinPrice}</p>
              )}
            </div>
          </div>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 1199</p>
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.privatePrice ? styles.inputError : ""
                } ${
                  form.privatePrice && !errors.privatePrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
              ...
              {errors.privatePrice && (
                <p className={styles.errorMsg}>⚠ {errors.privatePrice}</p>
              )}
            </div>
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 95,999</p>
              <div
                className={`${styles.inputWrapPrefix} ${
                  errors.inrPrivatePrice ? styles.inputError : ""
                } ${
                  form.inrPrivatePrice && !errors.inrPrivatePrice
                    ? styles.inputSuccess
                    : ""
                }`}
              >
              ...
              {errors.inrPrivatePrice && (
                <p className={styles.errorMsg}>⚠ {errors.inrPrivatePrice}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.seatInfoBanner}>
            ...
            <p className={styles.seatInfoText}>
              ...
              registration. You can manually correct it here if needed.
            </p>
          </div>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>
                Maximum capacity for this batch
              </p>
              <div
                className={`${styles.inputWrap} ${
            ...
            <div className={styles.fieldGroup}>
              ...
              <div
                className={`${styles.inputWrap} ${styles.inputDisabled}`}
              >
                <input
                  type="number"
                  className={styles.input}
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.fieldGroup}>
            ...
            <p className={styles.fieldHint}>
              Shown below the dates table on the frontend (e.g. early bird
              discount info)
            </p>
            <div className={styles.noteInputWrap}>
              ...
              <textarea
                ...
                rows={3}
                maxLength={400}
                placeholder="e.g. A $100 USD early bird discount is available on all accommodation types if booked 60 days in advance."
                value={form.note}
