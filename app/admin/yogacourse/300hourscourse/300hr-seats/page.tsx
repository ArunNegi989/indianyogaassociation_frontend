// FILE: src/app/admin/dashboard/300hr-seats/page.tsx
"use client";
...
export default function Seats300ListPage() {
 ...
 const fetchRows = async () => {
  try {
    const res = await api.get("/300hr-seats/all");
  ...
  if (!deleteId) return;
  try {
    await api.delete(`/300hr-seats/delete/${deleteId}`);
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>300 Hour — Seats & Dates</h1>
          <p className={styles.pageSubtitle}>
            Manage upcoming batch dates, fees and seat availability
          </p>
        </div>
        <Link
          href="/admin/yogacourse/300hourscourse/300hr-seats/add-new"
                ...
                <tr key={row._id} className={styles.row}>
                  ...
                  <td>
                    <div className={styles.actionBtns}>
                      <Link
                        href={`/admin/yogacourse/300hourscourse/300hr-seats/${row._id}`}
