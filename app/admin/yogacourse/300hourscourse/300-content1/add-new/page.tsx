...
export default function Add300hrContent1() {
  ...
  const removePara = (set: React.Dispatch<React.SetStateAction<{id:string;content:string}[]>>, id: string) =>
  ...
  if (submitted) return (
    <div className={styles.successScreen}><div className={styles.successCard}>
      ...
      <h2 className={styles.successTitle}>Content 1 Saved!</h2><p className={styles.successText}>Redirecting to list…</p>
    </div></div>
  );
    ...
    <div className={styles.formPage}>
      ...
      <div className={styles.formActions}>
        ...
        <button type="button"
          ...
          {isSubmitting ? <><span className={styles.spinner} /> Saving…</> : <><span>✦</span> Save Content 1</>}
        </button>
      </div>
    </div>
  );
