// FILE: src/app/admin/dashboard/500hr-seats/edit/[id]/page.tsx
"use client";
...
export default function Seats500EditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        router.replace("/admin/yogacourse/500hourscourse/500hr-seats");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(
        () =>
          router.push("/admin/yogacourse/500hourscourse/500hr-seats"),
        1500
      );
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link
          href="/admin/yogacourse/500hourscourse/500hr-seats"
