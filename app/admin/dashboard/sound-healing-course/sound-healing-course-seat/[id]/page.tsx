// FILE: src/app/admin/dashboard/sound-healing/sound-healing-seats/[id]/page.tsx
"use client";
...
export default function SoundHealingSeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/sound-healing-seats/get-batch/${id}`);
        ...
        setForm({
          ...
          totalSeats:   String(d.totalSeats   ?? 20),
          bookedSeats:  String(d.bookedSeats  ?? 0),
          note:         d.note ?? "",
        });
      } catch {
        toast.error("Failed to fetch batch");
        router.replace("/admin/dashboard/sound-healing-course/sound-healing-course-seat");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/sound-healing-seats/update-batch/${id}`, {
      ...
      setSubmitted(true);
      setTimeout(() => router.push("/admin/dashboard/sound-healing-course/sound-healing-course-seat"), 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link href="/admin/dashboard/sound-healing-course/sound-healing-course-seat" className={styles.breadcrumbLink}>
          Seats & Dates
        </Link>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.sectionBlock}>
          ...
          {dateRangePreview && (
            <div className={styles.datePreview}>
              ...
              <span className={styles.datePreviewNote}>— This is how it will appear on the frontend</span>
            </div>
          )}
        </div>
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 100 USD (Level 1)</p>
              <div className={`${styles.inputWrap} ${errors.usdFee ? styles.inputError : ""} ${form.usdFee && !errors.usdFee ? styles.inputSuccess : ""}`}>
                <input type="text" className={styles.input} placeholder="100 USD"
        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 500</p>
              <div className={`${styles.inputWrapPrefix} ${errors.dormPrice ? styles.inputError : ""} ${form.dormPrice && !errors.dormPrice ? styles.inputSuccess : ""}`}>
                ...
                <input type="number" className={styles.inputPrefixed} placeholder="500"
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 42,500</p>
              <div className={`${styles.inputWrapPrefix} ${errors.inrDormPrice ? styles.inputError : ""} ${form.inrDormPrice && !errors.inrDormPrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>₹</span>
                <input type="number" className={styles.inputPrefixed} placeholder="42,500"
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 800</p>
              <div className={`${styles.inputWrapPrefix} ${errors.twinPrice ? styles.inputError : ""} ${form.twinPrice && !errors.twinPrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>$</span>
                <input type="number" className={styles.inputPrefixed} placeholder="800"
          ...
          <div className={styles.twoCol}>
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 1200</p>
              <div className={`${styles.inputWrapPrefix} ${errors.privatePrice ? styles.inputError : ""} ${form.privatePrice && !errors.privatePrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>$</span>
                <input type="number" className={styles.inputPrefixed} placeholder="1200"
            ...
            <div className={styles.fieldGroup}>
              ...
              <p className={styles.fieldHint}>e.g. 1,02,000</p>
              <div className={`${styles.inputWrapPrefix} ${errors.inrPrivatePrice ? styles.inputError : ""} ${form.inrPrivatePrice && !errors.inrPrivatePrice ? styles.inputSuccess : ""}`}>
                <span className={styles.prefix}>₹</span>
                <input type="number" className={styles.inputPrefixed} placeholder="1,02,000"
            ...
            <div className={styles.fieldGroup}>
              ...
              <div className={`${styles.inputWrap} ${errors.totalSeats ? styles.inputError : ""} ${form.totalSeats && !errors.totalSeats ? styles.inputSuccess : ""}`}>
                <input type="number" className={styles.input} min="1" max="500"
                  placeholder="20" value={form.totalSeats}
        ...
        <div className={styles.formActions}>
          <Link href="/admin/dashboard/sound-healing-course/sound-healing-course-seat" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
