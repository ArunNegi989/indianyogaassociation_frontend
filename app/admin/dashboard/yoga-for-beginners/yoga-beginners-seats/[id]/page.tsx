...
export default function SeatsEditPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await api.get(`/yoga-beginners-seats/get-batch/${id}`);
        ...
        router.replace("/admin/dashboard/yoga-for-beginners/yoga-beginners-seats");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.put(`/yoga-beginners-seats/update-batch/${id}`, {
