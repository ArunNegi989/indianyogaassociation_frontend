...
export default function SeatsAddPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/yoga-beginners-seats/create-batch", {
      ...
      setSubmitted(true);
      setTimeout(() => router.push("/admin/dashboard/yoga-for-beginners/yoga-beginners-seats"), 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link href="/admin/dashboard/yoga-for-beginners/yoga-beginners-seats" className={styles.breadcrumbLink}>
          Seats & Dates
        </Link>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.formActions}>
          <Link href="/admin/dashboard/yoga-for-beginners/yoga-beginners-seats" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
