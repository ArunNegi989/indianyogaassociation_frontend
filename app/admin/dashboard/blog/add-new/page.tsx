...
const BLOCK_GROUPS = [
  {
    label: "Text",
    types: ["heading", "subheading", "paragraph", "list", "quote"] as SectionType[],
  },
  {
    label: "Media",
    types: ["images", "video"] as SectionType[],
  },
  {
    label: "Advanced",
    types: ["table", "callout", "code", "html", "divider", "spacer"] as SectionType[],
  },
];

/* ═══════════════════════════════════════════════
   JODIT CONFIG (memoized outside component)
════════════════════════════════════════════════ */
const joditConfig = {
  readonly: false,
  height: 320,
...
export default function AddBlogPage() {
  ...
  const handleSubmit = async (asDraft = false) => {
    ...
    try {
      ...
      await api.post("/blogs/create", fd, { headers: { "Content-Type": "multipart/form-data" } });
                            ...
                            <tr>
                              ...
                              <th style={{ padding: "0.3rem", width: "2rem" }}>
                                <button type="button" title="Remove column"
                                  ...
                                  onClick={() => removeTableCol(idx, (block.tableHeaders?.length ?? 1) - 1)}>
                                  ✕col
                                </button>
                              </th>
                            </tr>
                              ...
                              <div>
                                ...
                                <div style={{ display: "flex", gap: "0.4rem", alignItems: "center" }}>
                                  ...
                                  <button type="button"
                                    ...
                                    onClick={() => imageFileRefs.current[img.id]?.click()}
                                  >📁</button>
                                  <input
