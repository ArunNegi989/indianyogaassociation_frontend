    ...
    <main className={styles.page}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.gallery}>
            <div className={`${styles.galleryCard} ${styles.galleryCardMain}`}>
              ...
              <div
                className={styles.galleryFill}
                data-label="AYM Yoga School — Campus"
              />
            </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.prose}>
            <p className={styles.para}>
              ...
              Additionally, we focus on healing personal and family problems by
              practising simple, authentic, and traditional yoga.
            </p>
            <p className={styles.para}>
      ...
      >
        <div className={styles.container}>
          ...
          <div className={styles.prose}>
            <p className={styles.para}>
              In September 2005, it became apparent that a standard for yoga
              teacher training at the national level (in India) was necessary.
              Yogi Chetan Mahesh and other well-known yoga experts and great
              yoga Gurus decided to make a foundation to solve the matter. They
              registered an organization named{" "}
              <em>&apos;The Association for Yoga and Meditation&apos;</em> with
              the government of India.
            </p>
            <p className={styles.para}>
              The AYM YOGA SCHOOL in Rishikesh and other training institutes
              follow traditional and ancient yoga practices with a scientific
              approach. In 2005, AYM Yoga School of India also got the status as
              a National Organization of India and became a member of the (IYF)
              International Yoga Federation. AYM also sets standards for yoga
              study centres in India according to the IYF guidelines.
            </p>
            <p className={styles.para}>
              Graduates from AYM can register at IYF and the Yoga Alliance USA.
              National yoga associations organize yoga activities and sports
              nationally in most countries. The winners of national-level sports
              activities in India can be represented at international levels by
              IYF. In 2006, AYM passed a resolution to establish an
              administering body to maintain the international standards of yoga
              in the name of the Indian Yoga Alliance (IYA).
            </p>
          </div>
        </div>
      </section>
