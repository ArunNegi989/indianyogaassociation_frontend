    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.pageHeader}>
          <h1 className={styles.pageTitle}>Top Rated Yoga Teacher Training School in Pushkar</h1>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Yoga is renowned for enhancing a person's physical and mental wellness. Anyone
              who practices yoga and views it as art always looks forward to sharing it with
              others. At "Association for Yoga and Meditation," we allow you to do so through
              the yoga training course in Pushkar. We are a well-known provider of{" "}
              <strong className={styles.boldLink}>registered yoga teacher training courses in Pushkar</strong>{" "}
              that impart knowledge of yoga's more profound qualities. You can expect to
              transform into a professional here who aids others in obtaining the resources
              necessary for inner development.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              At our institution, the yoga instructors are no different from others as they
              strive to serve best. Through our{" "}
              <strong className={styles.boldLink}>yoga teacher training course near me</strong>,
              we help people learn every part of yoga from expert yoga gurus. We aid individuals
              in becoming real-world professionals by offering them yoga instructor certification
              near me. Our goal as a licensed yoga teacher training course provider in Pushkar
              is to nurture everyone who wishes to grow into a prosperous professional.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Association for Yoga and Meditation offers a yoga teaching course in Pushkar that
              encourages people to follow their natural urge to share the yoga experiences that
              have helped them grow. For students who wish to develop and study everything about
              yoga, we are a one-stop solution. Our goal is to provide a rich yoga experience
              alongside its advantages and components. Our teaching staff has years of experience
              and collaborates closely to ensure every step of your journey toward{" "}
              <strong className={styles.boldLink}>international yoga certification</strong> becomes
              as easy as possible.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              As the top yoga therapy teacher training, we handle all your expectations. We
              first assist you in becoming in shape, then educate you on how to acquire the
              proper yoga poses and assist others in managing their mental and physical well-being.
              You can relax and open your seven chakras by enrolling in our{" "}
              <strong className={styles.boldLink}>YTT in Pushkar</strong> and obtaining yoga
              teacher certification. Once you have chosen our yoga teacher training program in
              Pushkar, we will ensure you are ready for the real world and succeed.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Once you gain the knowledge from our yoga teacher training in Pushkar, you will
              be able to use it in the real world to assist people in overcoming emotional
              difficulties. With a well-designed classroom and a focused environment free of any
              distractions, we work effectively to provide aspiring training for yoga teachers in
              Pushkar. You can learn more about yoga from us under the guidance of experienced
              individuals. Then you get to receive a globally recognized{" "}
              <strong className={styles.boldLink}>YTT certification in Pushkar</strong>. As a
              reputable institution, we ensure that you receive complete training in ways that
              help you to grow as a professional in the future.
            </p>
          </div>
        </div>
