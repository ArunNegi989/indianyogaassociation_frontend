    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.pageHeader}>
          <h1 className={styles.pageTitle}>Yoga and Meditation Teaching Training in Agra</h1>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              At the Association for Yoga and Meditation, we help you to get immersed in the land
              where Yoga was born. Furthermore, being the{" "}
              <strong className={styles.boldLink}>best yoga teacher training in Agra</strong>, we
              help you to explore every aspect of it, including the traditional and modern ones.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              ...
              you will find us, where we offer you a chance to gain a solid foundation in the
              classical yogic tradition besides honing your teaching abilities. At the same time,
              we deepen your spiritual connection to Yoga so that you can prepare yourself for
              inner transformation before educating others. Our yoga therapy teacher training at
              the Association for Yoga and Meditation is entirely based on the Gurukul system. The
              instructors are well-educated, dedicated, and highly experienced to support and guide
              you throughout the journey of{" "}
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Our{" "}
              <strong className={styles.boldLink}>registered yoga teacher training course in Agra</strong>{" "}
              has gained quite a reputation among enthusiasts for being the best in the city and
              the nation. With a robust and peaceful ambience created, we ensure that you are
              surrounded by positive energy when learning the skills for becoming a successful yoga
              teacher in Agra. We allow you to interact closely with the masters and solve your
              queries. Our well-designed and extensive curriculum of{" "}
              <strong className={styles.boldLink}>yoga training courses in Agra</strong> covers
              practical training and in-depth theoretical knowledge.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              When you choose our{" "}
              <strong className={styles.boldLink}>yoga teacher training program in Agra</strong>,
              you can rest assured knowing that we will enlighten you with every tiny detail.
              Despite your knowledge, we believe in training you from scratch so you can
              thoroughly know even the minute aspects of Yoga. As the premium provider of{" "}
              <strong className={styles.boldLink}>yoga instructor certification in Agra</strong>,
              we ensure that you become fit and flexible before offering classes to others. Our
              licensed yoga teacher training course in Agra pushes one to be ready for the real
              world and act effortlessly as a professional. With us, you will learn and grow every
              day without going hard on yourself.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              During the course program, you will construct a solid foundation of discipline that
              fosters your physical, mental, emotional, and spiritual growth and a solid platform
              through which you can naturally and confidently instruct others. Our course
              curriculum is designed to create great yoga teachers and offer them{" "}
              <strong className={styles.boldLink}>YTT certification in Agra</strong>, which is
              well-adored worldwide. Our international yoga certification is precious no matter
              where you go to promote this ancient physical and mental therapy. By choosing us,
              you establish a foundation of Peace and tranquillity at a genuinely affordable
              expense.
            </p>
          </div>
        </div>
