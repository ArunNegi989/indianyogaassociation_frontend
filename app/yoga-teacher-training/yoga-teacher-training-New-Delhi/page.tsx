      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              We always believe that when it comes to training students, it is essential to first
              learn from professionals and then implement the same. If you are looking for the
              best course for{" "}
              <strong className={styles.boldLink}>yoga teacher training in New Delhi</strong>,
              then the best choice is none other than the Association of Yoga and Meditation.
              Since its inception, it has been our endeavor that we can provide a world-class
              training environment to all Yoga aspirants. When it comes to professional yoga
              therapy teacher training, you do not have to look anywhere else as we fill the
              void. AYM is your one-stop destination for the most profound training, and we have
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              We strongly believe that a trained teacher has to be a good student first; hence,
              if you want to start as a yoga teacher, you have to be a student first. The best
              thing about our professional course is that we have got it from some of the best
              experts who have calibrated yoga instructors all around the country and take out
              that time to train you. One of the major reasons AYM has been able to get such
              precedence as a good{" "}
              <strong className={styles.boldLink}>registered yoga training course in New Delhi</strong>{" "}
              is because of our proficiency in the field. Our team consists of the best teachers
              who will train you thoroughly.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Our{" "}
              <strong className={styles.boldLink}>yoga teacher training program</strong> is for
              everyone who aspires to be a professional yoga instructor! There are no two ways
              that the basic tenet for yoga is using your body lucidly and ensuring that you can
              develop strength. But in many cases, you do need amenities and resources, and that
              is what we provide the students during the training sessions. Do not worry. No
              matter what aid you need, we will ensure that we can arrange the same in an instant
              surpassing the industry's quality standards.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Once you start with our journey, you will be able to get the best exposure and
              transfer the same to your students as you practice! One of the essential factors
              is that we have tried to keep the price range extremely nominal so that anyone who
              aspires to be a yoga instructor does not feel restricted because of the investments.
              However, this does not imply that we tamper with the quality and does not focus on
              the quality of the{" "}
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Most of you would agree that the best thing you can do to add value to your entire
              forte is to add a certification to the same. When the certification is globally
              acclaimed, nothing can turn out better. We got you covered with that aspect. For
              the most professional and reliable{" "}
              <strong className={styles.boldLink}>YTT certification in New Delhi</strong>, feel
              free to contact us at Association for Yoga and Meditation. We will help you proceed
              further toward a bright career path.
            </p>
          </div>
        </div>
