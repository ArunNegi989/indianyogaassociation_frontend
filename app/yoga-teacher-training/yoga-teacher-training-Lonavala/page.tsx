      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              People visit Lonavala regularly for complete relaxation in a serene environment.
              But did you know that yoga is one of the most promising methods for relaxation?
              Hence, if you want to start your career as a professional yoga instructor in
              Lonavla, the best option is just before you! Association for Yoga and Meditation
              has got you the best{" "}
              <strong className={styles.boldLink}>yoga teacher training in Lonavala</strong>.
              The ultimate prerogative of this training program is to ensure that professionals
              can start practising without any hindrances in the best possible exposure in the
              field of yoga.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              To be a yoga teacher in Lonavala, you must focus on specific areas for a trainer
              to understand. The best thing about this course is that it has been curated keeping
              these needs in mind, and every professional ethics will be communicated to you so
              that you do not have any problem setting up your career in the real world. If you
              are based out of Lonavala and want to start on this journey as a professional yoga
              instructor, we are here to help you. We provide you with constant guidance in the
              field and assist you further in kickstarting your career as a{" "}
              <strong className={styles.boldLink}>registered yoga master</strong>. We are a
              registered yoga teacher training school in Lonavala, bringing you a world-class
              training environment at your doorstep.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              To become a professional and teach students, you must ensure that your basics are
              straightforward and that you know the exact measures to avoid glitches during the
              practice. In case you have any doubts that need to be cleared, you can easily
              approach the experts who have been in this field for a long time. They possess
              profound knowledge while guiding you through the basics and the advanced sections
              through deep understanding. The entire curriculum of the{" "}
              <strong className={styles.boldLink}>yoga teacher training program in Lonavala</strong>{" "}
              is planned out as such so that, starting from the basics to the advanced sections,
              you can get assistance at each of the levels. All you need to do is set up your
              mindset for a serene training platform and a bright career path, and you are almost
              there.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              One of the best things about the yoga therapy teacher training course conducted by
              AYM is that you will be given an innate focus on each factor, like the facilities.
              We know that there are indispensable facilities and resources to train students in
              the more advanced sections of yoga. Thus, we have them in place along with
              world-class infrastructure. The most crucial factor that we have focused on is
              ensuring that students can understand the insights of yoga and they can embark on
              their professional journey once they are done with the course. After attending the
              course, they receive a globally acclaimed{" "}
              <strong className={styles.boldLink}>certification</strong> as well.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              We understand that there is a common notion among many that when it comes to YTT
              certification in Lonavala, one needs to shell out a hefty amount. But that is
              different from the course curriculum set up by AYM. We have made it quite clear
              that when it comes to yoga, nothing can stop you from learning it through us and
              getting acclaimed worldwide as a{" "}
              <strong className={styles.boldLink}>certified yoga instructor</strong>. Even the
              price juncture should be separate from starting with a bright career path.
            </p>
          </div>
        </div>
