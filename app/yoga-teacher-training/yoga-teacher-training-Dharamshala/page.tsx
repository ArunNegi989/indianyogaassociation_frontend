    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.pageHeader}>
          <h1 className={styles.pageTitle}>Yoga Teacher Training School in Dharamshala</h1>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              ...
              <strong className={styles.boldLink}>yoga teacher training in Dharamshala</strong>{" "}
              but unable to find the perfect option suitable for you? Your search for the best
              yoga teaching course in Dharamshala ends as "Association for Yoga and Meditation"
              provides the most comprehensive professional course for teaching yoga to aspirants.
              The idea behind AYM is to ensure that students who want to pursue yoga in the long
              run and set up a career for themselves do not have to go through any fundamental
              problems and can get professional teacher training at Dharamshala.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Not only for the sole purpose of the yoga teaching certification, AYM thinks beyond
              that and ensures that each student who comes under the institution's wings can have
              the best understanding of what yoga is. Yoga is not only for the physical body;
              hence, focusing on mental well-being is equally important. Not only for those who
              want to build a career in Dharamshala, but the international yoga certification is
              also prevalent when getting certified under AYM. The idea has been to incorporate
              the best facilities and resources to give aspirants a holistic learning experience.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              I aspire to become a professional yoga instructor in the future. Nothing can be
              better than having experience, understanding how an instructor works, and ensuring
              students learn better. Exposure to the Association for Yoga and Meditation will
              help you understand that very well because you will be trained by experts who have
              been in the field for years. The knowledge that they tend to have is profound and
              innate. The best thing is that the yoga therapy teacher training curriculum is set
              so that you learn about yoga and how to conduct yourself as an instructor. Talking
              about the perks- you get a globally-acclaimed certification and license to start
              practising as a{" "}
              <strong className={styles.boldLink}>registered yoga instructor</strong>. We also
              help you start your professional career through exclusive guidance.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              One cannot just choose to open a yoga studio one fine day and start training
              students. They need the authority to train students and teach them yoga as a
              registered instructor. At the Association for Yoga and Meditation, our{" "}
              <strong className={styles.boldLink}>yoga teacher training program</strong> has been
              set so that after the training session, you can get certification without any
              hassle and start your endeavour. All you need to do is attend the classes with
              close attention, complete the course successfully, and see an excellent career
              waiting for you.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              ...
              <strong className={styles.boldLink}>licensed yoga teacher training course in Dharamshala</strong>.
              One must spend a lot. However, this is different; you only need to contact us at
              AYM. We have curated the course so that every enthusiast can afford professional
              training through the best institute in India without compromising the quality of
              training.
            </p>
          </div>
        </div>
