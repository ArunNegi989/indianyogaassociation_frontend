      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Our{" "}
              <strong className={styles.boldLink}>Yoga Teacher Training in Haryana</strong> is
              designed to support you on a transformative journey, nurturing a deeper understanding
              of yoga and meditation. Amidst the serene landscapes of Haryana, we provide a
              nurturing environment for personal growth and self-discovery. We're here to empower
              you with the skills and confidence to become a knowledgeable and compassionate yoga
              instructor.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Embarking on a{" "}
              <strong className={styles.boldLink}>yoga course in Haryana</strong> is not just about
              learning new skills; it's about personal growth and self-discovery. The serene and
              peaceful environment, surrounded by the natural beauty of Haryana, provides the
              perfect backdrop for this journey. You will deepen your practice, gain a deeper
              understanding of yoga philosophy and meditation, and cultivate the skills and
              confidence to become a knowledgeable and compassionate yoga instructor. But more than
              that, you will have the chance to experience profound personal growth and
              self-discovery, establishing a strong foundation for a lifelong yoga practice.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              ...
              <strong className={styles.boldLink}>yoga course in Haryana</strong>. The serene and
              peaceful environment provides the perfect setting for deepening your practice and
              learning. Additionally, Haryana offers a rich cultural and spiritual heritage that
              can enhance your understanding of yoga and its principles. Experienced instructors, a
              comprehensive curriculum, and the opportunity for profound personal growth are
              additional reasons to consider a yoga course in Haryana.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Sometimes, it can take work to balance work and professional life. It can get so
              daunting that you may need more time for yourself. Hence, this is when you can rely
              on us for{" "}
              <strong className={styles.boldLink}>online yoga teacher training courses in Haryana</strong>.
              We have our classes available, keeping the convenience of working professionals in
              mind.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "1rem" }}>
              Our classes come with pre-recorded videos, essential notes, updated class modules,
              and many more, to which students will have complete access. Students can even take{" "}
              <strong className={styles.boldLink}>online yoga TTC courses in Haryana</strong>{" "}
              anytime, as flexible slots are available.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "1rem" }}>
              Once the courses are over, students are offered{" "}
              <strong className={styles.boldLink}>recognized yoga teacher training certification</strong>{" "}
              of high value. This certification can be used anywhere in the world to start one's
              career as a yoga teacher in a reputed institution or one's yoga studio immediately.
            </p>
          </div>
        </div>
