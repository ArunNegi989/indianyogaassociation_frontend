    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            <p className={styles.bodyText}>
              ...
              <strong className={styles.boldLink}>Yoga Teacher Training (YTT) course in Kochi, India</strong>.
              Our comprehensive yoga teacher training program offers a perfect blend of
              traditional and modern yoga practices, providing aspiring yoga teachers with the
              knowledge, skills, and confidence to lead their classes.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "1rem" }}>
              Throughout the training, participants will delve into various aspects of yoga,
              including asana, pranayama, meditation, anatomy, philosophy, teaching methodology,
              and more. Our experienced and passionate instructors will guide students through an
              immersive learning experience that will foster personal growth and deepen their
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            <p className={styles.bodyText}>
              Located in Kochi, a serene and picturesque city, our training centre provides the
              ideal environment for self-reflection and learning. Participants can immerse
              themselves in India's rich culture and spiritual heritage, further enhancing their
              yoga journey.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "1rem" }}>
              Upon completing the program, graduates will receive a Yoga Alliance, USA
              certification, allowing them to teach yoga with confidence and credibility
              worldwide. Whether you want to deepen your practice or pursue a career as a yoga
              instructor, our{" "}
              <strong className={styles.boldLink}>yoga teacher training program in Kochi</strong>{" "}
              offers a life-changing experience that will inspire and empower you.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              The yoga course in Kochi offers many benefits, encompassing physical, mental, and
              spiritual well-being. Through the practice of yoga, participants can expect the
              following benefits:
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>1. Physical Fitness:</strong> The course helps improve flexibility,
              strength, and balance, leading to a healthier and more resilient body.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>2. Stress Reduction:</strong> Yoga provides effective relaxation techniques
              that help reduce stress and promote calm and inner peace.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>3. Mental Clarity:</strong> Through mindfulness and meditation, participants
              can experience improved mental clarity, focus, and emotional well-being.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            <p className={styles.bodyText}>
              <strong>4. Self-Exploration:</strong> The course offers a supportive environment
              for self-exploration and personal growth, allowing participants to deepen their
              understanding of themselves and others.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>5. Community and Support:</strong> A yoga course fosters a sense of
              community and provides a supportive network of like-minded individuals on a similar
              journey.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>6. Holistic Health:</strong> Yoga encourages a holistic approach to health,
              addressing physical fitness and mental and spiritual well-being.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              Overall, the yoga course in Kochi offers a transformative experience beyond
              physical practice, nurturing a balanced and harmonious way of living.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              There are several compelling reasons to join a yoga course in Kochi:
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>1. Spiritual Environment:</strong> with its serene and spiritual ambience,
              Kochi provides an ideal setting for immersing oneself in yoga and deepening one's
              spiritual connection.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>2. Experienced Instructors:</strong> The yoga courses in Kochi are led by
              experienced and knowledgeable instructors who can guide students on a transformative
              journey toward physical, mental, and spiritual well-being.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>3. Cultural Immersion:</strong> Kochi's rich cultural heritage and
              historical significance offer a unique backdrop for practising yoga, allowing
              participants to experience a deeper connection to the tradition and philosophy of
              yoga.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>4. Relaxing Surroundings:</strong> Kochi's natural beauty and tranquil
              surroundings create a peaceful and rejuvenating environment, perfect for
              self-reflection and personal growth.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              <strong>5. Yoga Alliance Certification:</strong> Completing a yoga course in Kochi
              can lead to a Yoga Alliance certification, enabling participants to teach yoga with
              credibility and confidence globally.
            </p>
            <p className={styles.bodyText} style={{ marginTop: "0.75rem" }}>
              Overall, joining a yoga course in Kochi offers an enriching and transformative
              experience. It allows one to deepen one's practice and embrace a holistic approach
              to well-being.
            </p>
          </div>
        </div>
