    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.pageHeader}>
          <h1 className={styles.pageTitle}>Yoga Teacher Training in Tamil Nadu</h1>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              The city of Mahabalipuram is famous for its ancient temples and beaches. These
              temples and beaches are carved with intricate carvings that date back thousands of
              years. In addition, the hills of Nilgiri are home to 2,000 wild animals.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              Tamil Nadu is the southernmost state in India and is known for its majestic temples
              displaying the Dravidian architectural style. Chennai is the capital of Tamil Nadu
              and it is the center of all commercial, industrial and cultural activities in
              southern India.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageLeft}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              ...
              <strong className={styles.boldLink}>yoga teacher training school in India</strong>,
              we are yoga masters in India. We specialize in teacher training and yoga emotion
              retreat. Our achievements are known for their quality of teaching from beginners to
              professionals. If you live or plan to visit Tamil Nadu, don't hesitate to discover
              the 7 chakras of yoga, chakra yoga poses, pranayama yoga and yoga mantra with our
              yoga masters, then our facilities here will also meet your experience and your
              needs.
            </p>
          </div>
        </div>
        ...
        <div className={`${styles.section} ${styles.sectionImageRight}`}>
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              AYM Yoga School is a professional yoga and meditation school located in Rishikesh
              and Goa. Our area of expertise is to provide high-quality{" "}
              <strong className={styles.boldLink}>yoga teacher training</strong> and yoga retreat
              service to anyone willing to enjoy the benefits of yoga in India. Enjoy Mantras,
              Pranayama, yoga prayer with our yoga teachers. Our outstanding achievements are
              widely recognized by students and professors all over the world. And if you live in
              Tamil Nadu or plan to visit, we also provide our facilities and{" "}
              <strong className={styles.boldLink}>training courses in Tamil Nadu</strong>.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.textWrap}>
            ...
            <p className={styles.bodyText}>
              AYM Yoga School is located in Rishikesh and Goa. We are a famous yoga and
              meditation institution in India, specializing in teacher training, yoga gurus. We
              are a non-profit organization that aims to teach quality yoga classes to anyone who
              wants to become a{" "}
              <strong className={styles.boldLink}>qualified yoga instructor</strong>. AYM Yoga
              School also helps you relieve emotional problems through yoga therapy retreat. In
              addition, if you are in Tamil Nadu, AYM Yoga School will also fully operate our
              facilities here.
            </p>
          </div>
        </div>
