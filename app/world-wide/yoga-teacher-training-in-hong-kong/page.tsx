...
import styles from "@/assets/style/world-wide/yoga-teacher-training-in-hong-kong/Hongkongpage.module.css";
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <section className={styles.heroSection}>
        <Mandala className={styles.heroBgMandala}/>
        <div className={styles.heroContent}>
          <div className={styles.heroImageSide}>
            <div className={styles.heroImageFrame}>
              <img
                src="https://www.yogaschoolrishikesh.com/wp-content/uploads/2019/09/yoga-teacher-training-in-rishikesh.jpg"
                alt="Yoga Teacher Training Rishikesh"
                className={styles.heroImage}
                onError={e=>{(e.target as HTMLImageElement).src="https://www.himalayanyogashram.com/images/yoga-teacher-training-rishikesh.jpg";}}
              />
              <div className={styles.heroImageOverlay}/>
              <Chakra className={styles.heroChakraTL} color="rgba(224,123,0,0.6)"/>
              <Chakra className={styles.heroChakraBR} color="rgba(196,106,0,0.5)"/>
              <div className={styles.heroImgBadge}>
                <span className={styles.heroImgBadgeText}>Est. 2005</span>
              </div>
            </div>
          </div>
          <div className={styles.heroText}>
            <div className={styles.heroPreRow}>
              <span className={styles.heroPreLine}/><span className={styles.heroPreTitle}>Association For Yoga & Meditation</span><span className={styles.heroPreLine}/>
            </div>
            <h1 className={styles.heroTitle}>
              Yoga Teacher<br/>Training In<br/><em className={styles.heroTitleEm}>Hong Kong</em>
            </h1>
            <div className={styles.heroOmRow}><span className={styles.heroOm}>ॐ</span></div>
            <p className={styles.heroSub}>Globally Recognised · Rishikesh Certified · Since 2005</p>
            <a href="#courses" className={styles.heroBtn}>
              Read More
      ...
      <section className={styles.contentSection}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.subHeading}>Get A Closer View Of The Yoga Teacher Training Program In Hong Kong</div>
          ...
          <div className={styles.facilitiesList}>
            {["We Must Arrange Flight Tickets From Hong Kong And Manage Foreign Students Visas.","We Offer Comfortable And Peaceful Accommodations To The Students","Our Students Will Get Meals Thrice A Day That Would Be Organic And Completely Healthy.","We Offer The Study Materials That May Be Required During The Completion Of The Course Program."].map((item,i)=>(
              <div key={i} className={styles.facilityItem}><span className={styles.facilityNum}>{i+1}.</span><span>{item}</span></div>
            ))}
          </div>
