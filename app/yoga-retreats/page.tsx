      ...
      {/* <section className={styles.accomSection}>
        ...
        <div className={styles.accomGrid}>
          <div className={styles.accomMain}>
            <img
              src={IMAGES.accomMain}
              alt="Main accommodation room"
        ...
        <div className={styles.container}>
          ...
          <OmDivider />
          <p className={styles.bodyPara}>
            Our <strong>Rishikesh yoga courses</strong> offer a flexible
            schedule. Depending on your area of interest, you can opt for
          ...
          <p className={styles.bodyPara}>
            ...
            the registration form and paying an advance deposit fee of{" "}
          ...
          <p className={styles.bodyPara}>
            ...
            due to unforeseen circumstances. However, we are happy to
            accommodate you for your next available date within one year.
          </p>
          <p className={styles.bodyPara}>
