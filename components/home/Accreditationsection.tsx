...
// ── Video Config ─────────────────────────────────────────────────────
// 👇 Bas yahan apna URL daalein — YouTube link ya MP4 path, baaki automatic
...
function SmartVideo({ src, poster }: { src: string; poster?: string }) {
  ...
  // YouTube URL — single iframe, src kabhi nahi badlega
  const youtubeEmbedUrl = getYouTubeEmbedUrl(src);
  if (youtubeEmbedUrl) {
    // Src ek baar set hoti hai — autoplay + muted + controls=1 (controls hamesha available)
    ...
    return (
      ...
      >
        {/* Iframe ek baar mount hoti hai, src change nahi hota — reload nahi hoga */}
        <iframe
          src={embedSrc}
  ...
  return (
    ...
    >
      ...
      {/* Controls bar — shows on hover/touch, hides after 3s */}
      <div style={{
      ...
      {/* Silent badge when idle */}
      {!isUserActive && (
        <div style={{
          position: 'absolute', bottom: '10px', left: '12px',
          background: 'rgba(0,0,0,0.5)', color: '#fff', fontSize: '12px',
          padding: '4px 10px', borderRadius: '20px', backdropFilter: 'blur(4px)',
          pointerEvents: 'none',
        }}>🔇 Hover for controls</div>
      )}
    </div>
  );
}
    ...
    <>
      <section className={styles.authenticSection}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.authGrid}>
            <div className={styles.authText}>
              <p className={styles.para}>
                Our Yoga Teacher Training in Rishikesh is accredited by Yoga Alliance USA,
                ensuring a globally recognized certification. We also align with the Yoga
                Certification Board (YCB) of India, under the Ministry of Ayush, Govt. of
                India, making our certification highly valued among aspiring yoga teachers
                worldwide.
              </p>
              <p className={styles.para}>
                Our yoga school in Rishikesh offers a well-structured and updated curriculum
                for Beginner, Foundation, Intermediate, and Advanced Yoga TTC in Rishikesh,
                ensuring that each student receives the best and most comprehensive yoga
                education.
              </p>
              <p className={styles.para}>
                Our training is deeply rooted in traditional yoga practices, including asana,
                pranayama, meditation, and detoxification techniques. We also offer
                specialized programs such as{' '}
                <strong className={styles.highlight}>Kundalini Yoga Teacher Training</strong>,{' '}
                <strong className={styles.highlight}>Prenatal Yoga Teacher Training</strong>, and{' '}
                <strong className={styles.highlight}>Hatha Yoga Teacher Training</strong>.
              </p>
              <p className={styles.para}>
                In addition to our immersive teacher training courses, we provide online
                Rishikesh yoga class training, connecting yoga enthusiasts worldwide. Whether
                you are a beginner or an advanced practitioner, our TTC in Rishikesh will
                help you deepen your practice and become a certified yoga teacher.
              </p>
            </div>
              ...
              <div className={styles.authImageFrame}>
                <div className={styles.authImageInner}>
                  <Image
                    ...
                    priority
                  />
                  <p className={styles.imageCaption}>AYM Study Materials &amp; Curriculum</p>
                </div>
          ...
          <div className={styles.videoImmerse}>
            ...
            {/* Smart Video — YouTube ya MP4 dono kaam karta hai */}
            ...
            <div className={styles.immerseBlock}>
              <h3 className={styles.immerseTitle}>Immerse Yourself in Yoga in Rishikesh</h3>
              <div className={styles.immerseDivider} />
              <p className={styles.para}>
                Rishikesh, the Yoga Capital of the World, invites you to embark on a journey
                of self-discovery and transformation. Nestled amidst the majestic Himalayas
                and the sacred Ganges River, this spiritual haven offers the perfect setting
                to deepen your practice and reconnect with yourself.
              </p>
              <p className={styles.para}>
                From mastering breathwork and asanas to exploring meditation, learning yoga
                in Rishikesh is a truly enriching experience — a gift of wellness and inner
      ...
      <section className={styles.recognitionSection}>
        <div className={styles.container}>
          ...
          <div className={styles.sectionHeaderCenter}>
            <h2 className={styles.sectionTitle}>Recognition &amp; Endorsements</h2>
            <div className={styles.titleUnderline} />
          </div>

          <div className={styles.recognitionText}>
            <p className={styles.para}>
              At AYM Yoga School in Rishikesh, a leading Yoga Teacher Training School in
              Rishikesh, all our programs are accredited by the Yoga Certification Board
              (YCB), India, and Yoga Alliance, USA. After completing any Yoga Teacher
              Training in Rishikesh, students can register with Yoga Alliance USA and
              receive an internationally recognized certification, paving the way for
              teaching opportunities worldwide.
            </p>
            <p className={styles.para}>
              If you're looking for the best Yoga TTC in Rishikesh, AYM Yoga School is the
              perfect place to begin your journey. As a well-established Yoga Teacher
              Training School in Rishikesh, we ensure a transformative experience where you
              can train with the best, immerse yourself in authentic yogic traditions, and
              unlock new possibilities in the yoga capital of the world.
            </p>
          </div>
            ...
            {certImages.map((cert) => (
              ...
              >
                <div className={styles.certImageWrap}>
                  <div className={styles.certImageContainer} style={{ position: 'relative', width: '100%', height: '248px' }}>
                    <Image
                      src={cert.src}
                      alt={cert.alt}
                      fill
                  ...
                  <div className={styles.certOverlay}>
                    ...
                    <span className={styles.certZoomText}>Click to Enlarge</span>
                  </div>
                </div>
          ...
          <div className={styles.badgesRow}>
            <div className={styles.badge}>
              ...
              <span className={styles.badgeText}>Yoga Alliance USA — RYS 200 &amp; 300 &amp; 500</span>
            </div>
            <div className={styles.badgeSep}>✦</div>
            <div className={styles.badge}>
              <span className={styles.badgeIcon}>🏛️</span>
              <span className={styles.badgeText}>YCB — Ministry of AYUSH, Govt. of India</span>
            </div>
            <div className={styles.badgeSep}>✦</div>
            <div className={styles.badge}>
              <span className={styles.badgeIcon}>🏆</span>
              <span className={styles.badgeText}>Global Excellence Awards 2019</span>
            </div>
          </div>
            ...
            <div className={styles.modalNav}>
              <button
                ...
                onClick={() => {
                  ...
                  setModalImg(certImages[(idx - 1 + certImages.length) % certImages.length]);
                }}
              >
                ← Prev
              </button>
              <span className={styles.modalNavCount}>
                {certImages.findIndex((c) => c.id === modalImg.id) + 1} / {certImages.length}
              </span>
              <button
                className={styles.modalNavBtn}
                onClick={() => {
