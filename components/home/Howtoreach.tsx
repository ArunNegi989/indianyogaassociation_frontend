      ...
      <div className={styles.container}>
        ...
        <div className={styles.headerWrap}>
          ...
          <p className={styles.subTitle}>
            ...
            <strong>Indian Yoga Association</strong> in Rishikesh —
            Delhi to Rishikesh travel options by air, train &amp; bus.
          </p>
        </div>

        {/* ══════════════════════════════════════════════════════════
            MAIN SPLIT:  LEFT (cards + pickup)  |  RIGHT (map only)
        ══════════════════════════════════════════════════════════ */}
        <div className={styles.splitLayout}>
          ...
          <div className={styles.leftPanel}>
            ...
            {/* ── Pickup & Drop — bottom of left panel ── */}
              ...
              {pickupOpen && (
                <div className={styles.pickupFormWrap}>
                  ...
                  <p className={styles.formSubtext}>
                    Fill in your details and we will arrange a comfortable transfer in Rishikesh
                    from airport, railway station or bus stand.
                  </p>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className={styles.formGrid}>
                      ...
                      {/* Submit + WhatsApp buttons side by side */}
                      <div className={styles.formGroupFull}>
